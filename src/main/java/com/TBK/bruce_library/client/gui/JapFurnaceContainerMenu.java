...
import com.TBK.bruce_library.common.register.MBMenuType;
...
public class JapFurnaceContainerMenu extends AbstractFurnaceMultiMenu {
    ...
    public JapFurnaceContainerMenu(int p_38852_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
        super(MBMenuType.JAP_FURNACE_MENU.get(), p_38852_);
        this.recipeType= MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get();
    ...
    protected boolean canSmelt(ItemStack p_38978_) {
        return this.level.getRecipeManager().getRecipeFor(MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get(), new SimpleContainer(p_38978_), this.level).isPresent();
    }

    protected boolean isFuel(ItemStack p_38989_) {
        return p_38989_.is(MBTags.IS_FUEL_FOR_SMITHING_FURNACE) && net.minecraftforge.common.ForgeHooks.getBurnTime(p_38989_, MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get()) > 0;
    }
