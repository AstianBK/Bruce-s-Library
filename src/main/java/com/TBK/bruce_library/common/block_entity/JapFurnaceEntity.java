package com.TBK.bruce_library.common.block_entity;

import com.TBK.bruce_library.client.gui.JapFurnaceContainerMenu;
import com.TBK.bruce_library.common.register.MBBlockEntity;
...
public class JapFurnaceEntity extends AbstractFurnaceBlockEntity {
    public JapFurnaceEntity(BlockPos p_154992_, BlockState p_154993_) {
        super(MBBlockEntity.JAP_FURNACE_ENTITY.get(), p_154992_, p_154993_, MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get());
    ...
    public boolean canPlaceItem(int p_58389_, ItemStack p_58390_) {
        if (p_58389_ == 7) {
            ...
            return net.minecraftforge.common.ForgeHooks.getBurnTime(p_58390_, MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get()) > 0 || p_58390_.is(Items.BUCKET) && !itemstack.is(Items.BUCKET);
        }
    }
    ...
    protected int getBurnDuration(ItemStack p_58343_) {
        if (p_58343_.isEmpty()) {
            ...
            return net.minecraftforge.common.ForgeHooks.getBurnTime(p_58343_, MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get());
        }
    }
