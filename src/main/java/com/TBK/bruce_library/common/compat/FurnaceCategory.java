...
import com.TBK.bruce_library.common.register.MBBlocks;
...
public class FurnaceCategory implements IRecipeCategory<RKFurnaceRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(BruceLibrary.MODID, "rk_furnace");
    private static final ResourceLocation TEXTURE = new ResourceLocation(BruceLibrary.MODID,"textures/gui/smithing_furnace.png");
