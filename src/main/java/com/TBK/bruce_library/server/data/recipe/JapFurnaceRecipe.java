package com.TBK.bruce_library.server.data.recipe;
...
public class JapFurnaceRecipe extends AbstractCookingRecipe {
    ...
    public JapFurnaceRecipe(ResourceLocation p_249379_, Ingredient addition1, Ingredient addition2, Ingredient addition3, Ingredient tool1, Ingredient tool2, Ingredient tool3, ItemStack p_252185_, float p_252165_, int p_250256_) {
        super(MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get(),p_249379_,"Horno",CookingBookCategory.MISC,addition1,p_252185_,p_252165_,p_250256_);
        this.type=MBRecipeSerializer.JAP_FURNACE_RECIPE_TYPE.get();
        this.id=p_249379_;
    ...
    public RecipeSerializer<?> getSerializer() {
        return MBRecipeSerializer.JAP_FURNACE_RECIPE.get();
    }
